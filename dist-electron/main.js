...
function registerIpc() {
    ...
    electron_1.ipcMain.handle("serverstatus:fetch", async () => {
        const json = await netGet("https://status.robertsspaceindustries.com/api/v2/summary.json", { "Accept": "application/json" });
        if (!json)
            return { ok: false };
        try {
